...
const en = {
  ...
  'tui.browse': 'Open',
  'tui.browseFolder': 'Destination folder',
  'tui.useFolder': 'use this folder',
  'tui.browseHelp': 'enter opens · h back · ~ home · p type a path · q close',
  'tui.browseHelpFolder': 'enter chooses · h back · ~ home · q close',
  'key.browse': 'Browse folders and images',
  'key.typePath': 'Type a path instead',
...
const it = {
  ...
  'tui.browse': 'Apri',
  'tui.browseFolder': 'Cartella di destinazione',
  'tui.useFolder': 'usa questa cartella',
  'tui.browseHelp': 'invio apre · h indietro · ~ home · p scrivi un percorso · q chiudi',
  'tui.browseHelpFolder': 'invio sceglie · h indietro · ~ home · q chiudi',
  'key.browse': 'Sfoglia cartelle e immagini',
  'key.typePath': 'Scrivi un percorso',
...
const es = {
  ...
  'tui.browse': 'Abrir',
  'tui.browseFolder': 'Carpeta de destino',
  'tui.useFolder': 'usar esta carpeta',
  'tui.browseHelp': 'intro abre · h atrás · ~ inicio · p escribir ruta · q cerrar',
  'tui.browseHelpFolder': 'intro elige · h atrás · ~ inicio · q cerrar',
  'key.browse': 'Explorar carpetas e imágenes',
  'key.typePath': 'Escribir una ruta',
  'tui.themeSet': 'Tema: {name}',
...
const fr = {
  ...
  'tui.browse': 'Ouvrir',
  'tui.browseFolder': 'Dossier de destination',
  'tui.useFolder': 'utiliser ce dossier',
  'tui.browseHelp': 'entrée ouvre · h retour · ~ maison · p saisir un chemin · q fermer',
  'tui.browseHelpFolder': 'entrée choisit · h retour · ~ maison · q fermer',
  'key.browse': 'Parcourir dossiers et images',
  'key.typePath': 'Saisir un chemin',
...
const de = {
  ...
  'tui.browse': 'Öffnen',
  'tui.browseFolder': 'Zielordner',
  'tui.useFolder': 'diesen Ordner nehmen',
  'tui.browseHelp': 'Enter öffnet · h zurück · ~ Home · p Pfad tippen · q schließen',
  'tui.browseHelpFolder': 'Enter wählt · h zurück · ~ Home · q schließen',
  'key.browse': 'Ordner und Bilder durchsehen',
  'key.typePath': 'Einen Pfad tippen',
